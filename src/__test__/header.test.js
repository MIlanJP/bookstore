...
describe("Test Books Container", () => {
    afterEach(cleanup);
    it("Renders the connected app with initialState with no errors", () => {
      render(
        ...
        { initialState: { user: "Redux User", cardquantity: 0 } }
      );
      expect(screen.getByText("Bookstore")).toBeInTheDocument();
    });

    it("Renders the Header to match snapShot", () => {
      ...
      it("Renders Logout Button", () => {
        const{queryAllByTestId}=  render(
          ...
          expect(queryAllByTestId("logoutButton")).toHaveLength(1)
        });
        ...
        it("Renders Logout Button", () => {
            const{queryAllByTestId}=  render(
              ...
              expect(queryAllByTestId("search")).toHaveLength(1)
            });
            ...
            it("Renders Logout Button", () => {
                const{queryAllByTestId}=  render(
                    ...
                    { initialState: { user: "Redux User", cardquantity: 3 } }
                  );
